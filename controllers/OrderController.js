...
const OrderController = props => {
    ...
    const [selectedAalamat, setSelectedAalamat] = useState('99');
    ...
    let alamat = [
        {
            "date": "5 May 2022",
            "name": "Package One Day",
            "price": "Rp 30.500",
        },
        {
            "date": "2 May 2022",
            "name": "Package Reguler",
            "price": "Rp 13.000",
        },
        {
            "date": "2 May 2022",
    ...
    const renderAlamatList = (offset) => {
        ...
        return (
            <TouchableOpacity onPress={() => props.navigation.navigate('OrderDetailController', { orderId: offset })} style={{ marginLeft: 10, marginTop: 0, width: '95%', backgroundColor: isSelected ? '#F4F0E5' : '#FFFFFF', padding: 5, borderRadius: 0 }}>
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <View style={{ width: '100%' }}>
                        <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-semi-bold', fontSize: 11, marginLeft: 10, marginTop: 5 }}>
                            {alamat[offset]['date']}
                        </Text>
                    </View>
                </View>
                <View style={{ flex: 1, flexDirection: 'row', marginTop: 0 }}>
                    <View style={{ width: '30%' }}>
                        <Image
                            ...
                            source={require('../assets/new/order-list.png')}
                        />
                    </View>
                    <View style={{ width: '70%' }}>
                        <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-bold', fontSize: 13, marginLeft: 25, marginTop: 10 }}>
                            Ashafa Laundry
                        </Text>
                        <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-regular', fontSize: 13, marginLeft: 25, marginTop: 5 }}>
                            {alamat[offset]['name']}
                        </Text>
                        <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-regular', fontSize: 13, marginLeft: 25, marginTop: 5 }}>
                            {alamat[offset]['price']}
        ...
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('DriverDeliveryController')} style={{ marginLeft: 10, marginTop: 0, marginBottom: 0, backgroundColor: '#74928A', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'flex-start' }}>
                        <View>
                            <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>Check Driver Deliver</Text>
                        </View>
                    </TouchableOpacity>
                </View>

                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('Home')} style={{ marginTop: 30, marginBottom: 20, backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'center' }}>
                        <View>
                            <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>Home</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </ScrollView>
...
OrderController.navigationOptions = {
    headerStyle: {
