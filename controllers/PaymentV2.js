...
LandingPage.navigationOptions = navigationData => {
    return {
        ...
        headerLeft: <></>,
        headerRight: <TouchableOpacity onPress={() => navigationData.navigation.navigate('PembayaranSuksesV2', {total: navigationData.navigation.getParam('total'), orderId: navigationData.navigation.getParam('orderId')})}><Text style={{ textAlign: 'center', fontSize: 12, color: '#000', marginRight: 12, fontFamily: 'poppins-semi-bold'}}>Tutup</Text></TouchableOpacity>,
    };
};
