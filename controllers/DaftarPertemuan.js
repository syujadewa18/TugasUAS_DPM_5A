...
const DaftarPertemuan = props => {
    ...
    const element = (data, index) => (
        <TouchableOpacity onPress={() => 
            props.navigation.navigate('DaftarPertemuanDetail', {
                idMateri: kbmData[index]['id'],
...
DaftarPertemuan.navigationOptions = navigationData => {
	return {
        headerTitle: 'Data Pertemuan',
