...
const LandingPage = props => { 
    ...
    //                         <Text style={{textAlign: 'center', fontFamily: 'poppins-regular', fontSize: 12}}>ver 2.1.1</Text>                        
    //                     </View>
    //                 </View>
    //             </ScrollView>
    //         </>
    ...
    // } else {
    //     return (
    //         <ScrollView style={{ marginTop: Platform.OS == 'ios' ? 0 : 30, backgroundColor: '#F6F0E4' }}>
    //             <Spinner
    //                 visible={isLoading}
    //                 textStyle={{ color: '#FFFFFF' }}
    //             />
    ...
    //                     <Image style={{ height: 240, width: '100%', resizeMode: 'contain', marginBottom: -5 }}  source={require('../assets/new/login.png')} />              
    //                     <View>
    ...
    //                             }}>
    //                                 <View style={{ width: '100%' }}>
    //                                     <Text style={{ marginTop: 10, fontSize: 13, color: '#000000', fontFamily: 'poppins-semi-bold', textAlign: 'right' }}>Forgot Password?</Text>
    //                                 </View>
    //                             </View>
    //                         </TouchableOpacity>
                            
    //                         <View style={styles.buttonContainer}>
    //                             <TouchableOpacity onPress={authHandler} style={{ backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '100%', alignSelf: 'center' }}>
    //                                 <View>
    //                                     <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>Login</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </View>
    //                     </View>
    ...
    //                     }}>
    //                         <View style={{width: '30%'}}>
    //                             <View style={{ marginTop: 10, borderColor: '#000000', borderWidth: 1 }}></View>
    //                         </View>
    //                         <View style={{width: '40%'}}>
    //                             <Text style={{ textAlign:'center', fontFamily: 'poppins-regular', color: '#000000' }}>Or login with</Text>
    //                         </View>
    //                         <View style={{width: '30%'}}>
    //                             <View style={{ marginTop: 10, borderColor: '#000000', borderWidth: 1 }}></View>
    //                         </View>
    ...
    //                             <TouchableOpacity>
    //                                 <Image source={require('../assets/new/facebook.png')} style={{ width: 'auto', height: 50 }} resizeMode="contain" />
    //                             </TouchableOpacity>
    //                         </View>
    //                         <View style={{width: '32%'}}>
    //                             {/* <TouchableOpacity onPress={signInGoogle}> */}
    //                             <TouchableOpacity>
    //                                 <Image source={require('../assets/new/google.png')} style={{ width: 'auto', height: 50 }} resizeMode="contain" />
    //                             </TouchableOpacity>
    //                         </View>
    //                         <View style={{width: '32%'}}>
    //                             {/* <TouchableOpacity onPress={signInFacebook}> */}
    //                             <TouchableOpacity>
    //                                 <Image source={require('../assets/new/apple.png')} style={{ width: 'auto', height: 50 }} resizeMode="contain" />
    //                             </TouchableOpacity>
    //                         </View>
    //                     </View>
    //                 </ScrollView>
