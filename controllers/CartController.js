            ...
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                <View>
                    <View style={{ marginBottom: 20 }}>
                        <Image
                            source={require('../assets/new/order-details.png')}
                            resizeMode="contain"
                    ...
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 20, marginBottom: 0 }}>Detail Order</Text>
                        </View>
                    </View>
...
CartController.navigationOptions = {
    headerStyle: {
