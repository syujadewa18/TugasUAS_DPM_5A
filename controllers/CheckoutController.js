        ...
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                <View>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 20, marginBottom: 0 }}>Checkout</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ borderWidth: 2, borderColor: '#000000', borderRadius: 20, borderTopWidth: 0, marginTop: -5, marginHorizontal: 10, paddingBottom: 20, borderWidth: 2, borderColor: '#000000' }}>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', marginTop: 20 }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 20, marginBottom: 0 }}>Bank Transfer</Text>
                        </View>
                    </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('ConfirmDeliveryController', { selectedPayment: selectedAalamat })} style={{ marginTop: 20, marginBottom: 20, backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'center' }}>
                        <View>
                            <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>Check Out</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </ScrollView>
...
CheckoutController.navigationOptions = {
    headerStyle: {
