...
const KepegawaianDetail = props => {
    ...
    //                         <Text style={{ borderWidth: 1, borderRadius: 20, padding: 10, textAlign: 'center', marginBottom: '5%' }}>Pegawai</Text>
...
KepegawaianDetail.navigationOptions = navigationData => {
	return {
        headerTitle: 'Informasi Pegawai',
...
export default KepegawaianDetail;