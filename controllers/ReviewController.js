    ...
    return (
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                <View>
                    <View style={{ borderWidth: 2, borderColor: '#000000', borderRadius: 20, marginTop: 20, marginHorizontal: 10, paddingBottom: 20 }}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 30 }}>
                            <View style={{ width: '100%' }}>
                                <Text style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-regular', fontSize: 13, marginBottom: 0 }}>I am happy with the good service, as expected and the results are good.</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, marginTop: 20 }}>
                            ...
                            <View style={{ width: '70%' }}>
                                <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-bold', fontSize: 13, marginLeft: 25, marginTop: 0 }}>
                                    Ashafa Laundry
                                </Text>
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity onPress={() => props.navigation.navigate('OrderDetailController')} style={{ marginTop: 20, backgroundColor: '#7F7F7F', padding: 5, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '50%', alignSelf: 'center' }}>
                            <View>
...
ReviewController.navigationOptions = {
    headerStyle: {
