...
const ProductsOverview = props => {
    ...
    const homeContentId = props.navigation.getParam('homeContentId') ? props.navigation.getParam('homeContentId') : '';
    ...
    if (homeContentId) {
        useEffect(() => {
            async function fetchData() {
                ...
                await dispatch(mAuth.fetchProductByPromoDefault());
                await dispatch(mAuth.fetchProductByPromo(0, homeContentId));
    ...
    let _productData = useSelector(state => state.auth.product_promo);
        ...
        <>  
            {
                ...
                (
                    <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: '25%' }}>
                        ...
                        <Text style={{ fontFamily: 'poppins-regular' }}>Yah promo tidak ditemukan</Text>
                    </View>
                )
            }
        </>
...
ProductsOverview.navigationOptions = navigationData => {
    ...
    return {
        ...
        headerTintColor: '#000',
        headerTitle: <Text numberOfLines={1} style={{ fontSize: 18, fontFamily: 'poppins-bold'}}>{navigationData.navigation.getParam('homeContentName')}</Text>,
