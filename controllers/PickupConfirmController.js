...
const PickupConfirmController = props => {
    ...
    const _selectedDate = props.navigation.getParam('selectedDate') ? props.navigation.getParam('selectedDate') : 1
    const _selectedHours = props.navigation.getParam('selectedHours') ? props.navigation.getParam('selectedHours') : '00'
    const _selectedMinutes = props.navigation.getParam('selectedMinutes') ? props.navigation.getParam('selectedMinutes') : '00'
    const _selectedAalamat = props.navigation.getParam('selectedAalamat') ? props.navigation.getParam('selectedAalamat') : 0
    const _selectedService = props.navigation.getParam('selectedService') ? props.navigation.getParam('selectedService') : 0
    const _selectedServiceAdditional = props.navigation.getParam('selectedServiceAdditional') ? props.navigation.getParam('selectedServiceAdditional') : 0

    const dateFormats = { weekday: 'short', day: 'numeric' };
    date.setDate(currentDate.getDate() + _selectedDate);
        ...
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                <View>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 20, marginBottom: 20 }}>Order Details</Text>
                        </View>
                    </View>

                    <View style={{ marginLeft: 10, marginTop: 10, width: '95%', backgroundColor: '#668983', padding: 5, borderWidth: 2, borderColor: '#668983', borderRadius: 20 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            <View style={{ width: '75%' }}>
                                <Text style={{ color: '#F4F0E5', textAlign: 'left', fontFamily: 'poppins-semi-bold', fontSize: 18, marginLeft: 10, marginTop: 5 }}>
                                    {date.toLocaleDateString('en-US', dateFormats)}
                                </Text>
                            </View>
                            <View style={{ flex: 1, width: '25%', marginTop: 5, backgroundColor: '#F4F0E5', borderColor: '#000000', borderWidth: 2, borderRadius: 20, alignItems: 'center', justifyContent: 'center' }}>
                                <Text style={{ color: '#000000', fontFamily: 'poppins-semi-bold', fontSize: 10 }}>
                                    {_selectedHours} : {_selectedMinutes}
                                </Text>
                            </View>
                        </View>
                    </View>

                    <View style={{ marginLeft: 10, marginTop: 25, width: '95%', backgroundColor: '#668983', padding: 5, borderWidth: 2, borderColor: '#668983', borderRadius: 20 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            <View style={{ width: '100%' }}>
                                <Text style={{ color: '#F4F0E5', textAlign: 'left', fontFamily: 'poppins-semi-bold', fontSize: 18, marginLeft: 10, marginTop: 5 }}>
                                    {services[_selectedService]["name"]}
                                </Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ marginLeft: 10, marginTop: 25, width: '95%', backgroundColor: '#668983', padding: 5, borderWidth: 2, borderColor: '#668983', borderRadius: 20 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            <View style={{ width: '100%' }}>
                                <Text style={{ color: '#F4F0E5', textAlign: 'left', fontFamily: 'poppins-semi-bold', fontSize: 18, marginLeft: 10, marginTop: 5 }}>
                                    {servicesAdditional[_selectedServiceAdditional]["name"]}
                                </Text>
                            </View>
                        </View>
                    </View>
                ...
                <View style={{ marginTop: 15 }}>
                    {renderAlamatList([_selectedAalamat])}
                </View>

                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('Home')} style={{ marginTop: 50, backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'center' }}>
                        <View>
                            <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>Process</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </ScrollView>
...
PickupConfirmController.navigationOptions = {
    headerStyle: {
...
export default PickupConfirmController;