...
const GuruPiketDetail = props => {
    ...
    //                         <Text style={{ marginTop: 10, fontWeight: 'bold' }}>{_getParam('namaLengkap')}</Text>

    //                         <View style={{ flexDirection: 'row', marginBottom: '5%', marginTop: '5%' }}>
    //                             <View style={{ flex: 1, height: 2, marginHorizontal: 0, maxWidth: '50%', backgroundColor: 'black' }} />
    //                         </View>

    //                         <Text style={{ marginTop: 0, fontStyle: 'italic', marginBottom: 20 }}>Kelas: {_getParam('kelas')}</Text>
    ...
    //                         <Text style={{ fontSize: 11, marginTop: 10 }}>Kelas: {_getParam('kelas')}</Text>
    ...
    //                         <Text style={{ borderWidth: 1, borderRadius: 20, padding: 10, textAlign: 'center', marginBottom: '5%' }}>Guru Piket</Text>
...
GuruPiketDetail.navigationOptions = navigationData => {
	return {
        headerTitle: 'Informasi Guru Piket',
...
export default GuruPiketDetail;