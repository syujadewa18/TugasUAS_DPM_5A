...
const DropOffConfirmController = props => {
                ...
                <View>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ width: '100%' }}>
                            ...
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold' }}>No Orderan : #GLA28I3A0C</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', marginTop: 30, marginBottom: 0 }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'center', marginLeft: 10, fontFamily: 'poppins-semi-bold', color: 'blue', fontSize: 10 }}>Antar langsung ke Ashafa Laundry yuk!</Text>
                        </View>
                    </View>

                    <Image source={require('../assets/new/dropoff-alamat.png')} resizeMode="contain" style={{ width: '100%', height: 200 }} />
                </View>
...
DropOffConfirmController.navigationOptions = {
    headerStyle: {
...
export default DropOffConfirmController;