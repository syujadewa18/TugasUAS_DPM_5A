            ...
            try {
                ...
                if (result.status == true) {
                    setTimeout(async () => {
                        ...
                        props.navigation.navigate('CreatePasswordSuccess');
                    }, 100);
                } else {
        ...
        <ScrollView style={{ marginTop: Platform.OS == 'ios' ? 0 : 0, backgroundColor: '#F6F0E4' }}>
            ...
            <View style={styles.gradient}>
                <Card style={styles.authContainer}>
                    <Image style={{ height: 160, width: '100%', resizeMode: 'contain', marginBottom: -5 }}  source={require('../assets/new/create-new-password.png')} />              
                    ...
                    <View>
                        ...
                        <View style={styles.buttonContainer}>
                            <TouchableOpacity onPress={forgotPasswordHandler} style={{ backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '100%', alignSelf: 'center' }}>
                                <View>
                                    <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>Reset Password</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                    </View>
