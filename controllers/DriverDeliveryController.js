...
const DriverDeliveryController = props => {
        ...
        <>
            <ScrollView >
                <View style={{ marginBottom: 0 }}>
                    <Image
                        source={require('../assets/new/map.png')}
                        resizeMode="contain"
                        style={{ width: '100%', height: 240 }}
                    />
                </View>
                <View style={{ paddingHorizontal: 20, marginTop: 20, margin: 3 }}>
                    <View style={{ marginLeft: 10, marginTop: 0, width: '95%', backgroundColor: '#668983', padding: 5, borderWidth: 2, borderColor: '#668983', borderRadius: 20 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            <View style={{ width: '100%' }}>
                    ...
                    <View style={{ borderWidth: 2, borderColor: '#000000', borderRadius: 20, borderTopWidth: 0, marginTop: -5, marginHorizontal: 10, paddingBottom: 20 }}>
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 20 }}>
                            <View style={{ width: '15%' }}>
                                <Image
                                    source={require('../assets/new/house.png')}
                                    resizeMode="contain"
                                    style={{ width: 20, height: 20 }}
                                />
                            </View>
                            <View style={{ width: '85%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 13, marginBottom: 0 }}>Home</Text>
                                <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-regular', fontSize: 11, marginLeft: 10, marginTop: 2 }}>
                                    Jalan Surya Baru III, RT.3/RW.2, Tanah Merah, Bukit Raya BUKIT RAYA, KOTA PEKANBARU, RIAU, ID 28284
                                </Text>
                            </View>
                        </View>

                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, marginTop: -30 }}>
                            <View style={{ width: '15%' }}>
                                <Image
                                    source={require('../assets/new/dash.png')}
                                    resizeMode="contain"
                                    style={{ width: 20, height: 20 }}
                                />
                            </View>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 30 }}>
                            <View style={{ width: '15%' }}>
                                <Image
                                    source={require('../assets/new/location.png')}
                                    resizeMode="contain"
                                    style={{ width: 20, height: 20 }}
                                />
                            </View>
                            <View style={{ width: '85%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 13, marginBottom: 0 }}>Ashafa Laundry</Text>
                                <Text style={{ color: '#000000', textAlign: 'left', fontFamily: 'poppins-regular', fontSize: 11, marginLeft: 10, marginTop: 2, marginBottom: 20 }}>
                                    Jalan Air Dingin, Kel. Air Dingin, Kec. Bukit Raya BUKIT RAYA, KOTA PEKANBARU, RIAU, ID 28288
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 0 }}>
                            <View style={{ width: '50%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 13, marginBottom: 0 }}>Total</Text>
                            </View>
                            <View style={{ width: '15%' }}>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('CheckoutController')} style={{ marginTop: 20, backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'center' }}>
                        <View>
...
DriverDeliveryController.navigationOptions = {
    headerStyle: {
...
export default DriverDeliveryController;