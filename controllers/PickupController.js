        ...
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                <View>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 20, marginBottom: 20 }}>Set a Pick-Up Schedule</Text>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold' }}>Select Pickup Date</Text>
                        </View>
                    </View>

                    <ScrollView style={{ flex: 1, marginBottom: 20 }} horizontal={true}>
                    ...
                    <View>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold' }}>Select Pickup Time</Text>
                        </View>
                            ...
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                                <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 10, elevation: 5 }}>
                                    ...
                                    <TouchableOpacity onPress={closeModal}>
                                        <Text style={{ padding: 10, backgroundColor: '#F4F0E5', color: '#668983', textAlign: 'center', fontFamily: 'poppins-semi-bold' }}>Confirm</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity onPress={closeModal} style={{ marginTop: 10 }}>
                                        <Text style={{ padding: 10, backgroundColor: '#668983', color: '#F4F0E5', textAlign: 'center', fontFamily: 'poppins-semi-bold' }}>Cancel</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </Modal>

                        <TouchableOpacity onPress={openModal} style={{ marginLeft: 10, marginTop: 10, width: '95%', backgroundColor: '#668983', padding: 5, borderWidth: 2, borderColor: '#668983', borderRadius: 20 }}>
                            <View style={{ flex: 1, flexDirection: 'row' }}>
                                <View style={{ width: '75%' }}>
                                    <Text style={{ color: '#F4F0E5', textAlign: 'left', fontFamily: 'poppins-semi-bold', fontSize: 25, marginLeft: 10, marginTop: 5 }}>
                    ...
                    <View>
                        <View style={{ width: '100%', marginTop: 20 }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold' }}>Select Pickup Address</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('ServiceController', { selectedDate: selectedDate, selectedHours: selectedHours, selectedMinutes: selectedMinutes, selectedAalamat: selectedAalamat })} style={{ marginTop: 20, backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'center' }}>
                        <View>
...
PickupController.navigationOptions = {
    headerStyle: {
