...
const Checkout = props => {
    ...
    const lihatOrderSayaHandler = async () => {
        ...
        await dispatch(mCart.removePurchaseCart());
        await dispatch(mAuth.removePurchase());
    ...
    const totalTagihan = props.navigation.getParam('totalTagihan')
                            ...
                            <View style={{ marginBottom: 0 }}>
                                <View style={{flex: 1, flexDirection: 'row'}}>
                                    <View style={{ width: '100%' }}>
                                        <Text style={{ textAlign: 'left', color: '#000', fontFamily: 'poppins-regular', fontSize: 14, marginBottom: 0 }}>Batas Waktu Pembayaran</Text>
                                        <Text>
                                            <CountDown
                                                until={3600}
                                                size={25}
                                                digitStyle={{backgroundColor: '#FFF', margin: 0, textAlign: 'left'}}
                                                digitTxtStyle={{textAlign: 'left', color: '#000', fontFamily: 'poppins-semi-bold', fontSize: 26}}
                                                // timeLabelStyle={{ padding: 0 }}
                                                timeToShow={['H', 'M', 'S']}
                                                timeLabels={{h: '', m: '', s: ''}}
                                                style={{ padding: 0, backgroundColor: '#FFF', textAlign: 'left' }}
                                                separatorStyle={{ textAlign: 'left', backgroundColor: '#FFF',  color: '#000', fontFamily: 'poppins-semi-bold', fontSize: 26}}
                                                showSeparator={true}
                                            />
                                        </Text>
                                    </View>
                                ...
                                <View style={{marginLeft: 15, flex: 1, flexDirection: 'row'}}>
                                    <View style={{ width: '50%' }}>
                                        <TouchableOpacity onPress={lihatOrderSayaHandler}>
                                            <View style={{ marginTop: 0, marginBottom: 20, width: 150, height: 50, padding: 10, backgroundColor: '#FFF', borderRadius: 10, borderColor: '#6BB745', borderWidth: 1 }}>
                                    ...
                                    <View style={{ width: '50%' }}>
                                        <TouchableOpacity 
                                            ...
                                            >
                                            <View style={{ marginTop: 0, marginBottom: 20, width: 150, height: 50, padding: 10, backgroundColor: '#6BB745', borderRadius: 10, borderColor: '#6BB745', borderWidth: 1 }}>
