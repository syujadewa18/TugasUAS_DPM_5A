...
const ConfirmDeliveryController = props => {
    ...
    let alamat = [
        {
            ...
            "image": require('../assets/new/bca.png'),
        },
        {
            "name": "BNI Transfer Bank",
            "accountNumber": "1123456789",
            "image": require('../assets/new/bni.png'),
        },
        {
            "name": "BRI Transfer Bank",
            "accountNumber": "2123456789",
            "image": require('../assets/new/bri.png'),
        },
    ]
    const renderAlamatList = (offset) => {
        ...
        return (
            <TouchableOpacity onPress={() => setSelectedAalamat(offset)} style={{ marginLeft: 10, marginTop: 15, width: '95%', backgroundColor: isSelected ? '#F4F0E5' : '#FFFFFF', padding: 5, borderWidth: 1, borderColor: isSelected ? '#000000' : '#000000', borderRadius: 20 }}>
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <View style={{ width: '30%' }}>
                        <Image
                            style={{ width: 70, height: 50, resizeMode: 'contain' }}
                            source={alamat[offset].image}
                        />
                    </View>
                    <View style={{ width: '70%' }}>
    ...
    const _selectedPayment = props.navigation.getParam('selectedPayment') ? props.navigation.getParam('selectedPayment') : 0
        ...
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                <View>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ width: '100%' }}>
                            <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-bold', fontSize: 20, marginBottom: 0 }}>Confirm Delivery</Text>
                        </View>
                    </View>

                    <View style={{ borderWidth: 2, borderColor: '#000000', borderRadius: 20, marginHorizontal: 10, paddingBottom: 20, borderWidth: 2, borderColor: '#000000', marginTop: 10 }}>
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 10 }}>
                            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                                <Image
                                    style={{ width: 70, height: 50, resizeMode: 'contain' }}
                                    source={alamat[_selectedPayment].image}
                                />
                            </View>
                        </View>
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 0 }}>
                            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 13, marginBottom: 0 }}>{alamat[_selectedPayment].name}</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 0 }}>
                            <View style={{ width: '50%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>Account Number</Text>
                            </View>
                            <View style={{ width: '15%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>:</Text>
                            </View>
                            <View style={{ width: '35%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>{alamat[_selectedPayment]['accountNumber']}</Text>
                            </View>
                        </View>
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 10 }}>
                            <View style={{ width: '50%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>ID Transaction</Text>
                            </View>
                            <View style={{ width: '15%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>:</Text>
                            </View>
                            <View style={{ width: '35%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>#ABCDE01234</Text>
                            </View>
                        </View>
                        <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, paddingTop: 10 }}>
                            <View style={{ width: '50%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>Nominal Transfer</Text>
                            </View>
                            <View style={{ width: '15%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>:</Text>
                            </View>
                            <View style={{ width: '35%' }}>
                                <Text numberOfLines={1} style={{ textAlign: 'left', marginLeft: 10, fontFamily: 'poppins-semi-bold', fontSize: 10, marginBottom: 0 }}>Rp 30.500</Text>
                            </View>
                        </View>
                        <View style={{ paddingHorizontal: 20, paddingTop: 10 }}>
                            <View style={{ backgroundColor: '#d9534f', padding: 5 }}>
                                <Text style={{ fontFamily: 'poppins-semi-bold', color: '#FFFFFf', fontSize: 10 }}>Transfer before 12.40 or the transaction will be canceled automatically.</Text>
                            </View>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.reset([NavigationActions.navigate({ routeName: 'CartController' })], 0)} style={{ marginTop: 20, backgroundColor: '#74928A', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '100%', alignSelf: 'center' }}>
                        <View>
                            <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>I already made the payment</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.reset([NavigationActions.navigate({ routeName: 'CartController' })], 0)} style={{ marginTop: 10, backgroundColor: '#74928A', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '100%', alignSelf: 'center' }}>
                        <View>
                            <Text style={{ color: 'white', textAlign: 'center', fontFamily: 'poppins-regular' }}>I canceled the payment</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </ScrollView>
...
ConfirmDeliveryController.navigationOptions = {
    headerStyle: {
...
export default ConfirmDeliveryController;