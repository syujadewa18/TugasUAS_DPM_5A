...
const ServiceController = props => {
    ...
    const selectedHours = props.navigation.getParam('selectedHours')
    const selectedMinutes = props.navigation.getParam('selectedMinutes')
    const selectedAalamat = props.navigation.getParam('selectedAalamat')
        ...
        <>
            <ScrollView style={{ paddingHorizontal: 20, marginTop: 10, margin: 3 }}>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={() => props.navigation.navigate('PickupConfirmController', { selectedMinutes: selectedMinutes, selectedDate: selectedDate, selectedHours: selectedHours, selectedAalamat: selectedAalamat, selectedService: selectedService, selectedServiceAdditional: selectedServiceAdditional })} style={{ marginTop: 20, backgroundColor: '#7F7F7F', padding: 10, borderWidth: 2, borderColor: 'white', borderRadius: 10, width: '60%', alignSelf: 'center' }}>
                        <View>
...
ServiceController.navigationOptions = {
    headerStyle: {
